################################################################################
# This is a crontab example for arkg.mooo.com - (uid: soulivore)
# Generated 2023-05-28 17:19:03 PST @ http://freedns.afraid.org/
################################################################################
# NOTES:
...
# 3) To verify updates are occuring, wait 5 minutes, then 'cat /tmp/freedns_arkg_mooo_com.log'
...
# 
# Example #1:
# wget -O - http://freedns.afraid.org/dynamic/update.php?SDVmdktQbkxmaWlLTUVyU0VoaW06MTg2Mjk1Mjc=
# 
# Example #2:
# curl http://freedns.afraid.org/dynamic/update.php?SDVmdktQbkxmaWlLTUVyU0VoaW06MTg2Mjk1Mjc=
# 
# Example #3:
# fetch -o - http://freedns.afraid.org/dynamic/update.php?SDVmdktQbkxmaWlLTUVyU0VoaW06MTg2Mjk1Mjc=

# You might need to include this path line in crontab, (or specify full paths)
PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin

2,7,12,17,22,27,32,37,42,47,52,57 * * * * sleep 8 ; wget -O - http://freedns.afraid.org/dynamic/update.php?SDVmdktQbkxmaWlLTUVyU0VoaW06MTg2Mjk1Mjc= >> /tmp/freedns_arkg_mooo_com.log 2>&1 &
